Característica: asignación de valores para un campo has_many desde una fit-table en un recurso concreto

  Escenario: Asignación de valores para un campo has_many desde una fit-table en un recurso concreto
  ########################################################################
  # Patrón: 
  ...
  #   asociándolas al recurso cuyo modelo sea _mod_padre_ llamado
  #   _nombre_padre_.
  # 
  ...
  ########################################################################
    Dado que tenemos dos huertos llamado "H-01 y H-02"
       Y que el huerto "H-01" tiene los siguientes bancales: 
       | nombre | longitud | cultivo |  matas |
       |  A-01  |    12    | Patatas |     16 |
       |  A-02  |    12    | Tomates |     28 |
       |  B-01  |    10    | Berzas  |     18 |
       Y que la huerta "H-02" tiene los siguientes bancales: 
       | nombre | longitud | cultivo |  matas |
       |  C-01  |    42    | Patatas |     38 |
